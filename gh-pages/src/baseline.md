...
- <img alt="Baseline newly available icon" src="/assets/img/baseline-newly-icon.svg" style="width:2em;vertical-align:center;"> **Newly available**:

  The feature works across the latest devices and browser versions. The feature might not work in older devices or browsers. Indicated with a blue icon.

- <img alt="Baseline widely available icon" src="/assets/img/baseline-widely-icon.svg" style="width:2em;vertical-align:center;"> **Widely available**:

  The feature is well established and works across many devices and browser versions. It's been available across browsers for at least 2½ years (30 months). Indicated with a green icon.

Prior to being newly available, a feature has <img alt="Limited availability icon" src="/assets/img/baseline-limited-icon.svg" style="width:2em;vertical-align:center;"> **Limited availability** when it's not yet available across all browsers.
...
## Find the Baseline status of a feature

You can find at-a-glance Baseline statuses on [Can I Use](https://caniuse.com/) feature entries, and [MDN Web Docs](https://developer.mozilla.org/) reference pages.

See [Baseline in the wild](/baseline-in-the-wild/) for more examples.

You can [use Baseline on your site](/use-baseline/) too.

## Baseline ownership and maintenance

The Baseline definition is written and maintained by the [web-features owners group](https://github.com/web-platform-dx/web-features/blob/main/GOVERNANCE.md).
