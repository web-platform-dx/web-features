...
declare const browsers: import("./types.quicktype").Browsers, features: {
    [key: string]: FeatureData | import("./types").FeatureMovedData | import("./types").FeatureSplitData;
}, groups: {
 ...
 */
declare function getStatus(featureId: string | undefined, bcdKey: string): Status | undefined;
